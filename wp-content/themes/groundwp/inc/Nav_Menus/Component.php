<?php
/**
 * GroundWP\GroundWP\Nav_Menus\Component class
 *
 * @package groundwp
 */

namespace GroundWP\GroundWP\Nav_Menus;
 ...
 * * `groundwp()->is_primary_nav_menu_active()`
 * * `groundwp()->display_primary_nav_menu( array $args = [] )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			[
				static::PRIMARY_NAV_MENU_SLUG => \esc_html__( 'Primary', 'groundwp' ),
			]
		);
	}
	 ...
	 */
	public function filter_primary_nav_menu_dropdown_symbol( $item_output, WP_Post $item, $depth, $args ) {
	 ...
	 */
	public function is_primary_nav_menu_active() {
